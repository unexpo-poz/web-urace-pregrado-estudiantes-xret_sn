...
function resaltar(lSeccion) {
	...
	// Deshabilitado el 19/06/2014 para retiro sin normativa
	/*if (true) {
	...
	limite_ret	= document.getElementById('limite').value;// linea 1037 planilla_r.php
	t_mat_insc	= document.pensum.mat_insc.value;// linea 215 planilla_r.php
	t_mat_ret	= document.totales.t_mat.value;// linea 651 planilla_r.php

	if ((t_mat_insc-t_mat_ret) > limite_ret) { // Si supera el limite de materias a retirar
		msg = 'Disculpe, esta intentando retirar mas asignaturas de los permitido.\n';
		msg+= 'Su condicion permite retirar un maximo de dos (2) asignaturas.';
		noRetira = true;
